...
{<h1 className="mt-10 mb-4 text-left text-[2.5rem] font-bold tracking-tight">Что можно посетить🧭</h1>}

{<p className="mb-16 text-left text-lg text-gray-500 dark:text-gray-400">Построим маршрут </p>}

<Cards>
  <ShowcaseCard title="Харама Хайата" href="/haram">
    <>![Node.js preview](./showcase/hrama.png)</>
  </ShowcaseCard>
